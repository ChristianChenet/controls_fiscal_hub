...
$config = [
    ...
    'auto_nfse_nsu_limit' => (int) env_value('AUTO_NFSE_NSU_LIMIT', '100'),
    'nfse_robot_max_cycles' => (int) env_value('NFSE_ROBOT_MAX_CYCLES', '80'),
    'nfse_robot_time_limit_seconds' => (int) env_value('NFSE_ROBOT_TIME_LIMIT_SECONDS', '1800'),
