...
if ($page === 'documents_export') {
    ...
    foreach ($docs as $doc) {
        ...
        foreach ([
            ...
            format_date_short($doc['entrada_date_erp'] ?? null),
    ...
    try {
        ...
        $rows = array_map(static function (array $doc): array {
            ...
            return [
                ...
                'entrada_date_erp' => format_date_short($doc['entrada_date_erp'] ?? null),
...
$viewData = [
    ...
    'settings' => [
        ...
        'cte_cancelled_erp_alert_emails' => $repo->getSetting('cte_cancelled_erp_alert_emails', (string)($config['cte_cancelled_erp_alert_emails'] ?? '')),
