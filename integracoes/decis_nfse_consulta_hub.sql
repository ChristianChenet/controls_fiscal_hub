...
SELECT
    ...
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "DECIS_DATA_ENTRADA",
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "DECIS_DT_INCLUSAO",
    ...
    TO_CHAR(B.issue_date, 'YYYY-MM-DD') AS "VDNOTAC_DATA_EMISSAO",
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "VDNOTAC_DATA_MOVIMENTACAO",
    ...
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "VDNOTAC_DATA_INCLUSAO",
    P.USUARIO_DECIS AS "VDNOTAC_USUARIO_INCLUSAO",
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "VDNOTAC_DATA_ALTERACAO",
    ...
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "VDNOTAS_DATA_INCLUSAO",
    P.USUARIO_DECIS AS "VDNOTAS_USUARIO_INCLUSAO",
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "VDNOTAS_DATA_ALTERACAO",
    ...
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "CGPESSOA_DATA_ALTERACAO",
    P.USUARIO_DECIS AS "CGPESSOA_USUARIO_ALTERACAO",
    TO_CHAR(P.DATA_ENTRADA_DECIS, 'YYYY-MM-DD') AS "CGPESSOA_DATAHORAINCLUSAO",
